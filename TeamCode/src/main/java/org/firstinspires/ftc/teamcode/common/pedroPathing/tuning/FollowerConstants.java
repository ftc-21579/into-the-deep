...
public class FollowerConstants {
    ...
    private static double xMovement = 71.86431259158869;
    private static double yMovement = 52.3789;
    ...
    public static double forwardZeroPowerAcceleration = -43.564316041915895;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -83.30272948993736;
    ...
    // This can be custom set for each Path.
    public static double pathEndTValueConstraint = 0.85;
