...
@Config
public class AutoToDepositCommand extends SequentialCommandGroup {
    ...
    public AutoToDepositCommand(Bot bot, double angle, double ext) {
        addCommands(
                new InstantCommand(() -> bot.setState(BotState.DEPOSIT)),
                new SetExtensionCommand(bot.getExtension(), 0.0),
                new InstantCommand(() -> bot.setState(BotState.DEPOSIT)),
                new SetPivotAngleCommand(bot.getPivot(), angle),
